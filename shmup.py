...
#        pygame.draw.circle(self.image, RED, self.rect.center, self.radius)
        self.rect.x = random.randrange(WIDTH - self.rect.width) #x spawn coord for mob
        self.rect.y = random.randrange(-150, -100) #y spawn coord
        self.speedy = random.randrange(1,8) # Some slow ones and some fast ones
    ...
    def update(self):
        ...
        if self.rect.top > HEIGHT + 10 or self.rect.left < -25 or self.rect.right > WIDTH + 20:
            self.rect.x = random.randrange(WIDTH - self.rect.width) #x spawn coord for mob
            self.rect.y = random.randrange(-100, -40) #y spawn coord
...
while running:
    ...
    for hit in hits:
        ...
        if player.shield <= 0:
            ...
            player.kill()
        # If player died and death explosion has finished playing
